/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 202404526ff2d50402e5736396e886bd)
// Runtime types generated with workerd@1.20251210.0 2025-08-29 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/api/index");
		durableNamespaces: "MyAgent";
	}
	interface Env {
		BETTER_AUTH_URL: "https://hackday-cf-vite-setup.your-subdomain.workers.dev";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "ENVIRONMENT">> {}
}
